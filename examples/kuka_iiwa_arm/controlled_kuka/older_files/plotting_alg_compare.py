...
dir = "/Users/ira/Documents/drake/examples/kuka_iiwa_arm/controlled_kuka/output/alg_compare_basic/"
...
# separate data
feas_tols = processData(7)
opt_tols = processData(8)
...
iterations = processData(9)
[times, time_means, time_stds] = processDataMeans(10)
[feas, feas_means, feas_stds] = processDataMeans(12)
[constraints, constraint_means, constraint_stds] = processDataMeans(14)
[objectives, objective_means, objective_stds] = processDataMeans(15)
