        ...
        namespace complete_robobee {
            namespace {
                ...
                int do_main(int argc, char* argv[]) {
                    ...
                    //input_upper_bound << 180, 200, 30, 30;
                    //input_lower_bound << 100, 160, -30, -30;
                    
                    input_upper_bound << 200, 200, 200, 200;
                    input_lower_bound << -200, -200, -200, -200;
