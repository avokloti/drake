    ...
    namespace examples {
        namespace complete_robobee {
            namespace {
                ...
                // system and context
                CompleteRobobeePlant<double>* plant = new CompleteRobobeePlant<double>();
                ...
                Eigen::VectorXd solveADMM(systems::trajectory_optimization::admm_solver::AdmmSolverBase* solver, std::string solver_name, double rho1, double rho2, double rho3, int trial, Eigen::Ref<Eigen::VectorXd> initial_traj) {
                    ...
                    std::cout << "\n=============== Solving problem " << trial << " with " << solver_name << ": rho1 = " << rho1 << ", rho2 = " << rho2 << ", rho3 = " << rho3 << "!\n" << std::endl;
                ...
                void initializeValues(int trial) {
                    ...
                    if (OBS) {
                        ...
                        // set output folder
                        output_folder = "/Users/ira/Documents/drake/examples/complete_robobee/output/rho_sweep_v1_obstacles/";
                        ...
                        // set output folder
                        output_folder = "/Users/ira/Documents/drake/examples/complete_robobee/output/rho_sweep_v1/";
                    }
                }
...
int main(int argc, char* argv[]) {
    return drake::examples::complete_robobee::do_main(argc, argv);
}
...
/*
 ...
 systems::trajectory_optimization::MidpointTranscription traj_opt(quadrotor, *context_ptr, N, T/N, T/N);
