    ...
    namespace examples {
        namespace acrobot {
            namespace {
                ...
                // system and context
                AcrobotPlant<double>* acrobot = new AcrobotPlant<double>();
                auto acrobot_context_ptr = acrobot->CreateDefaultContext();
                
                // state start and end
                const Eigen::VectorXd x0 = (Eigen::VectorXd(4) << 0, 0, 0, 0).finished();
                const Eigen::VectorXd xf = (Eigen::VectorXd(4) << math::pi, 0, 0, 0).finished();
                
                Eigen::VectorXd state_upper_bound(4);
                Eigen::VectorXd state_lower_bound(4);
                
                double T = 5.0;
                int N = 20;
                double dt = T/N;
                
                int num_states = acrobot_context_ptr->get_num_total_states();
                int num_inputs = acrobot->get_input_port(0).size();
                ...
                void calculateIntegrationError(std::string filename, int trial, trajectories::PiecewisePolynomial<double> traj_x, trajectories::PiecewisePolynomial<double> traj_u) {
                    ...
                    for (int i = 0; i < N-1; i++) {
                        ...
                        acrobot_context_ptr->get_mutable_continuous_state().SetFromVector(state_value);
                        auto input_port_value = &acrobot_context_ptr->FixInputPort(0, acrobot->AllocateInputVector(acrobot->get_input_port(0)));
                        ...
                        std::unique_ptr<systems::ContinuousState<double> > continuous_state(acrobot->AllocateTimeDerivatives());
                        acrobot->CalcTimeDerivatives(*acrobot_context_ptr, continuous_state.get());
                ...
                void solveSwingUpADMM(int trial) {
                    
                    // initialize solver
                    systems::trajectory_optimization::AdmmSolver solver = systems::trajectory_optimization::AdmmSolver(acrobot, x0, xf, T, N, 400);
                    ...
                    writeTrajToFileTol("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_admm_x", trial, xtraj_admm, num_states, elapsed_time.count(), max_iter);
                    writeTrajToFileTol("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_admm_u", trial, utraj_admm, num_inputs, elapsed_time.count(), max_iter);
                    
                    calculateIntegrationError("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_admm_x", trial, xtraj_admm, utraj_admm);
                }
                
                solvers::SolutionResult solveSwingUpIPOPT(int trial) {
                    systems::trajectory_optimization::MidpointTranscription dircol(acrobot, *acrobot_context_ptr, N, T/N, T/N);
                    ...
                    writeTrajToFileTol("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_ipopt_x", trial, xtraj_ipopt, num_states, elapsed_time.count(), max_iter);
                    writeTrajToFileTol("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_ipopt_u", trial, utraj_ipopt, num_inputs, elapsed_time.count(), max_iter);
                    
                    calculateIntegrationError("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_ipopt_x", trial, xtraj_ipopt, utraj_ipopt);
                    
                    return result;
                }
                
                solvers::SolutionResult solveSwingUpSNOPT(int trial) {
                    ...
                    const std::string print_file = "/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/snopt" + std::to_string(trial) + ".out";
                    ...
                    writeTrajToFileTol("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_snopt_x", trial, xtraj_snopt, num_states, elapsed_time.count(), max_iter);
                    writeTrajToFileTol("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_snopt_u", trial, utraj_snopt, num_inputs, elapsed_time.count(), max_iter);
                    
                    calculateIntegrationError("/Users/irinatolkova/Dropbox/2017-2018/Summer2018/acrobot/acrobot_obstacles_snopt_x", trial, xtraj_snopt, utraj_snopt);
                ...
                int do_main(int argc, char* argv[]) {
                    ...
                    solveSwingUpADMM(0);
                    ipopt_results[i] = solveSwingUpIPOPT(0);
                    snopt_results[i] = solveSwingUpSNOPT(0);
