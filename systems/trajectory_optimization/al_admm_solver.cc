...
#include "drake/systems/trajectory_optimization/al_admm_solver.h"
...
namespace drake {
    namespace systems {
        namespace trajectory_optimization {
            namespace al_admm_solver {
            
            /* ---------------------------------------------- SOLVER INITIALIZATION ---------------------------------------------- */
            
            ALAdmmSolver::ALAdmmSolver(systems::System<double>* par_system, Eigen::VectorXd par_x0, Eigen::VectorXd par_xf, double par_T, int par_N, int par_max_iter) {
            ...
            void ALAdmmSolver::setRho1(double rho) {
                initial_rho1 = rho;
            }
            
            void ALAdmmSolver::setRho2(double rho) {
                initial_rho2 = rho;
            }
            
            void ALAdmmSolver::setRho3(double rho) {
                initial_rho3 = rho;
            }
            
            void ALAdmmSolver::setFeasibilityTolerance(double tol) {
                tol_feasibility = tol;
            }
            
            void ALAdmmSolver::setConstraintTolerance(double tol) {
                tol_constraints = tol;
            }
            
            void ALAdmmSolver::setStateUpperBound(Eigen::Ref<Eigen::VectorXd> bound) {
            ...
            void ALAdmmSolver::setStateLowerBound(Eigen::Ref<Eigen::VectorXd> bound) {
                if (bound.size() != num_states) {
            ...
            void ALAdmmSolver::setInputUpperBound(Eigen::Ref<Eigen::VectorXd> bound) {
            ...
            void ALAdmmSolver::setInputLowerBound(Eigen::Ref<Eigen::VectorXd> bound) {
                if (bound.size() != num_inputs) {
            ...
            Eigen::MatrixXd ALAdmmSolver::getSolutionStateTrajectory() {
                return solution_x;
            }
            
            Eigen::MatrixXd ALAdmmSolver::getSolutionInputTrajectory() {
                return solution_u;
            }
            
            trajectories::PiecewisePolynomial<double> ALAdmmSolver::reconstructStateTrajectory() {
            ...
            trajectories::PiecewisePolynomial<double> ALAdmmSolver::reconstructInputTrajectory() {
                // check if problem has been solved
                if (!solve_flag) {
                    cerr << "Cannot reconstruct trajectory -- problem has not been solved successfully.\n";
                }
            ...
            void ALAdmmSolver::addInequalityConstraintToAllKnotPoints(single_constraint_function f, int constraint_size, std::string constraint_name) {
            ...
            void ALAdmmSolver::addEqualityConstraintToAllKnotPoints(single_constraint_function f, int constraint_size, std::string constraint_name) {
                // make individual constraint structure
            ...
            void ALAdmmSolver::addInequalityConstraintToConsecutiveKnotPoints(double_constraint_function f, int constraint_size, std::string constraint_name) {
                // make individual constraint structure
            ...
            void ALAdmmSolver::addEqualityConstraintToConsecutiveKnotPoints(double_constraint_function f, int constraint_size, std::string constraint_name) {
                // make individual constraint structure
            ...
            void ALAdmmSolver::solve(Eigen::Ref<Eigen::VectorXd> y) {
            ...
            /*
            int ALAdmmSolver::nonzeroCount(Eigen::Ref<Eigen::MatrixXd> A) {
                int count = 0;
            ...
            Eigen::VectorXd ALAdmmSolver::proximalUpdateObjective(Eigen::Ref<Eigen::VectorXd> nu, Eigen::Ref<Eigen::MatrixXd> R, double rho1) {
            ...
            Eigen::VectorXd ALAdmmSolver::proximalUpdateConstraints(Eigen::Ref<Eigen::VectorXd> nu, Eigen::Ref<Eigen::SparseMatrix<double> > M, Eigen::Ref<Eigen::VectorXd> c, Eigen::Ref<Eigen::SparseMatrix<double> > G, Eigen::Ref<Eigen::VectorXd> h, double rho1, double rho2, double rho3) {
            ...
            double ALAdmmSolver::getStateFromY(Eigen::Ref<Eigen::VectorXd> y, int time_index, int index) {
                return (y[time_index * num_states + index]);
            }
            
            double ALAdmmSolver::getInputFromY(Eigen::Ref<Eigen::VectorXd> y, int time_index, int index) {
                return (y[N * num_states + time_index * num_inputs + index]);
            }
            
            
            // DOUBLE INTEGRATOR DYNAMICS
            void ALAdmmSolver::integratorDynamics(double time_index, Eigen::Ref<Eigen::VectorXd> state, Eigen::Ref<Eigen::VectorXd> input, Eigen::Ref<Eigen::VectorXd> f, Eigen::Ref<Eigen::MatrixXd> Aii, Eigen::Ref<Eigen::MatrixXd> Bii) {
                f[0] = state[1];
                f[1] = input[0];
            ...
            /*
            // QUAD DYNAMICS
            void ALAdmmSolver::quadDynamics(double time_index, Eigen::Ref<Eigen::VectorXd> x, Eigen::Ref<Eigen::VectorXd> u, Eigen::Ref<Eigen::VectorXd> f, Eigen::Ref<Eigen::MatrixXd> Aii, Eigen::Ref<Eigen::MatrixXd> Bii) {
            ...
            /*
             ...
             void ALAdmmSolver::allConstraints(double time_index, Eigen::Ref<Eigen::VectorXd> x, Eigen::Ref<Eigen::VectorXd> u, Eigen::Ref<Eigen::VectorXd> g, Eigen::Ref<Eigen::MatrixXd> dg) {
            ...
            void ALAdmmSolver::stateUpperBoundConstraint(double t, Eigen::Ref<Eigen::VectorXd> x, Eigen::Ref<Eigen::VectorXd> u, Eigen::Ref<Eigen::VectorXd> g, Eigen::Ref<Eigen::MatrixXd> dg_x, Eigen::Ref<Eigen::MatrixXd> dg_u) {
                g = x - x_upper_bound;
                dg_x = Eigen::MatrixXd::Identity(num_states, num_states);
                dg_u = Eigen::MatrixXd::Zero(num_states, num_inputs);
            }
            
            void ALAdmmSolver::stateLowerBoundConstraint(double t, Eigen::Ref<Eigen::VectorXd> x, Eigen::Ref<Eigen::VectorXd> u, Eigen::Ref<Eigen::VectorXd> g, Eigen::Ref<Eigen::MatrixXd> dg_x, Eigen::Ref<Eigen::MatrixXd> dg_u) {
                g = x_lower_bound - x;
                dg_x = -1 * Eigen::MatrixXd::Identity(num_states, num_states);
                dg_u = Eigen::MatrixXd::Zero(num_states, num_inputs);
            }
            
            void ALAdmmSolver::inputUpperBoundConstraint(double t, Eigen::Ref<Eigen::VectorXd> x, Eigen::Ref<Eigen::VectorXd> u, Eigen::Ref<Eigen::VectorXd> g, Eigen::Ref<Eigen::MatrixXd> dg_x, Eigen::Ref<Eigen::MatrixXd> dg_u) {
                g = u - u_upper_bound;
                dg_x = Eigen::MatrixXd::Zero(num_inputs, num_states);
                dg_u = Eigen::MatrixXd::Identity(num_inputs, num_inputs);
            }
            
            void ALAdmmSolver::inputLowerBoundConstraint(double t, Eigen::Ref<Eigen::VectorXd> x, Eigen::Ref<Eigen::VectorXd> u, Eigen::Ref<Eigen::VectorXd> g, Eigen::Ref<Eigen::MatrixXd> dg_x, Eigen::Ref<Eigen::MatrixXd> dg_u) {
                g = u_lower_bound - u;
                dg_x = Eigen::MatrixXd::Zero(num_inputs, num_states);
                dg_u = -1 * Eigen::MatrixXd::Identity(num_inputs, num_inputs);
            }
            /*
            void ALAdmmSolver::stateInputConstraints(double time_index, Eigen::Ref<Eigen::VectorXd> x, Eigen::Ref<Eigen::VectorXd> u, Eigen::Ref<Eigen::VectorXd> x_upper_bound, Eigen::Ref<Eigen::VectorXd> x_lower_bound, Eigen::Ref<Eigen::VectorXd> u_upper_bound, Eigen::Ref<Eigen::VectorXd> u_lower_bound, int num_states, int num_inputs, Eigen::Ref<Eigen::VectorXd> g, Eigen::Ref<Eigen::MatrixXd> dg) {
            ...
            /*
             ...
             void ALAdmmSolver::obstacleConstraints(double time_index, Eigen::Ref<Eigen::VectorXd> x, Eigen::Ref<Eigen::VectorXd> u, obstacle* obs, int num_constraints, int N, int num_states, int num_inputs, Eigen::Ref<Eigen::VectorXd> g, Eigen::Ref<Eigen::MatrixXd> dg) {
            ...
            void ALAdmmSolver::placeAinM(std::vector<Triplet<double> >* tripletsMptr, Eigen::Ref<Eigen::MatrixXd> Aii, int ii) {
            ...
            void ALAdmmSolver::placeBinM(std::vector<Triplet<double> >* tripletsMptr, Eigen::Ref<Eigen::MatrixXd> Bii, int ii) {
            ...
            // CONSTRUCT C VECTOR
            void ALAdmmSolver::makeCVector(Eigen::Ref<Eigen::VectorXd> c, int ii, Eigen::Ref<Eigen::VectorXd> mid_state, Eigen::Ref<Eigen::VectorXd> mid_input, Eigen::Ref<Eigen::VectorXd> fii, Eigen::Ref<Eigen::MatrixXd> Aii, Eigen::Ref<Eigen::MatrixXd> Bii, Eigen::Ref<Eigen::VectorXd> y) {
            ...
            // PLACE IN G
            /*
             void ALAdmmSolver::placeinG(int ii, std::vector<Triplet<double> >* tripletsGptr, Eigen::Ref<Eigen::MatrixXd> point_dg_x, Eigen::Ref<Eigen::MatrixXd> point_dg_u) {
            ...
            void ALAdmmSolver::placeinG(std::vector<Triplet<double> >* tripletsGptr, Eigen::Ref<Eigen::MatrixXd> single_dg_x, Eigen::Ref<Eigen::MatrixXd> single_dg_u, int ii, int running_constraint_counter, int cf_length) {
