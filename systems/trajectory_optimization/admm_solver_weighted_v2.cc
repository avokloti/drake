                    ...
                    //while (i < 250) {
                        ...
                        for (int iii = 0; iii < int(single_constraints_list.size()); iii++) {
                            ...
                            for (int ii = 0; ii < N; ii++) {
                                ...
                                //if (i == 0) {
                                //    std::cout << "Four norms for " << cf.constraint_name << ": " << single_g.norm() << " -- " << std::sqrt(single_dg_x.norm() * single_dg_x.norm() + single_dg_u.norm() * single_dg_u.norm()) << std::endl;
                                //}
                        ...
                        for (int iii = 0; iii < int(double_constraints_list.size()); iii++) {
                            ...
                            for (int ii = 0; ii < N-1; ii++) {
                                ...
                                if (i == 0) {
                                    //std::cout << "Four norms for this point: " << single_g.norm() << " -- " << single_dg_x1.norm() << " -- " << single_dg_u1.norm() << " -- " << single_dg_x2.norm() << " -- " << single_dg_u2.norm() << std::endl;
                                }
