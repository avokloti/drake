    ...
    namespace systems {
        namespace trajectory_optimization {
            namespace admm_solver {
                ...
                class AdmmSolverAL : public AdmmSolverBase {

                public:
                    // constructor:
                    AdmmSolverAL(systems::System<double>* par_system, Eigen::VectorXd par_x0, Eigen::VectorXd par_xf, double par_T, int par_N, int par_max_iter);
                    
                    AdmmSolverAL(systems::System<double>* par_system);
